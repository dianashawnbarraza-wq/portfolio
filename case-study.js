(function () {
  ...
  const CASE_STUDIES = [
    { file: 'case-study-checking.html', title: 'Turning Square Checking from a pass-through account into a financial home' },
    { file: 'case-study-biller-network.html', title: 'Tackling Square Bill Pay growth plateau post-launch' },
